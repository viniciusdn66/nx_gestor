Public Class CadSubGroup
    ...
    Private Sub CadSubGroup_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TbsubgroupTableAdapter.Fill(Me.DbsubgroupDataSet.tbsubgroup)
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        TbsubgroupBindingSource.AddNew()
    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Me.Validate()
        Me.TbsubgroupBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.DbsubgroupDataSet)
        Msg.Show()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If InterfUI.Tipo_de_UsuárioTextBox.Text = "Desenvolvedor" Then
            Me.TbsubgroupBindingSource.RemoveCurrent()
            Me.Validate()
            Me.TbsubgroupBindingSource.EndEdit()
            Me.TableAdapterManager.UpdateAll(Me.DbsubgroupDataSet)
        Else
