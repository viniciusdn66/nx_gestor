Public Class CadGroup
    ...
    Private Sub BtnClose_Click(sender As Object, e As EventArgs) Handles BtnClose.Click
        Close()
    End Sub
    Private Sub CadGroup_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.TbgroupTableAdapter.Fill(Me.DbgroupDataSet.tbgroup)
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        TbgroupBindingSource.AddNew()
    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Me.Validate()
        Me.TbgroupBindingSource.EndEdit()
        Me.TableAdapterManager.UpdateAll(Me.DbgroupDataSet)
        Msg.Show()
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If InterfUI.Tipo_de_UsuárioTextBox.Text = "Desenvolvedor" Then
            Me.TbgroupBindingSource.RemoveCurrent()
            Me.Validate()
            Me.TbgroupBindingSource.EndEdit()
            Me.TableAdapterManager.UpdateAll(Me.DbgroupDataSet)
        Else
